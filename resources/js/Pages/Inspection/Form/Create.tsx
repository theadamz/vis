...
const idPrefix = "00000000-0000-0000-0000-";

const Create = ({ vehicleTypes }: PageProps<{ vehicleTypes: VehicleType[] }>): JSX.Element => {
    /*** inertia js ***/
    const props = usePage<PageProps>().props;
    const { data, setData, post, processing, errors } = useForm<InspectionFormRequest>({
        id: undefined,
        vehicle_type_id: undefined,
        type: InspectionType.LOADING,
        code: "",
        name: "",
        use_eta_dest: false,
        use_ata_dest: false,
        ...
        <>
            ...
            <header className="sticky top-16 z-10 w-full flex items-center px-6 bg-white shadow justify-between h-14">
                <div className="items-center">
                    <div className="font-semibold text-md leading-tight text-gray-800">Create Form</div>
                    <Separator className="my-1" />
                    <Breadcrumbs items={[{ label: "Inspection" }, { label: "Forms", link: route("ins.form.index") }, { label: "Create" }]} />
                </div>
